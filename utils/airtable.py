...
class AirtableManager:
    ...
    def create_event(self, title: str, description: str, start_time: str, end_time: str, host_name: str, host_pfp: str):
        event = self.events_table.create(
            {
                "Title": title,
                "Description": description,
                "Start Time": datetime.fromtimestamp(start_time, timezone.utc).isoformat(),
